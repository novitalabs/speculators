...
###############################################################################
# Buffer cleanup DISABLED — .23 has 4.9TB disk, no need to evict
# Exp15 and earlier Exp17 runs crashed repeatedly due to cleanup deleting files
# that training was about to read. With sufficient disk space, just keep all data.
echo "[cleanup] DISABLED (sufficient disk space on .23)"
CLEANUP_PID=""
