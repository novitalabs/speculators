...
###############################################################################
# Exp 15: MiniMax-M2.5 Novita 0320 Datagen (Larger Dataset)
# Downloads weilan55/novita20260320 from HF, preprocesses, and generates
...
DATASET_DIR="${DATASET_DIR:-/data/datasets/novita20260320}"
...
echo "============================================="
echo " Exp 15: MiniMax-M2.5 Novita 0320 Datagen"
...
if [ -z "$(find "$DATASET_DIR" -name "*.json" -o -name "*.jsonl" 2>/dev/null | head -1)" ]; then
    echo "[Step 0a] Downloading weilan55/novita20260320 from HuggingFace..."
    ...
    huggingface-cli download weilan55/novita20260320 \
        --repo-type dataset \
