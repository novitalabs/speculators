...
###############################################################################
# MiniMax-M2.5 Novita Full Dataset Datagen (writes manifest for streaming training)
# Uses full ~52K Novita API log conversations from weilan55/novita20260309
###############################################################################
...
NOVITA_JSONL="${NOVITA_JSONL:-/data/datasets/novita20260309/conversations_full.jsonl}"

GEN_DIR="$OUTPUT_PATH/gen"
MANIFEST_PATH="$GEN_DIR/manifest.json"

echo "============================================="
echo " MiniMax-M2.5 Novita Full Datagen"
...
###############################################################################
# Step 0: Preprocess Novita logs (full dataset, no sample limit)
###############################################################################
if [ ! -f "$NOVITA_JSONL" ]; then
    echo "[Step 0] Preprocessing Novita API logs (full dataset)..."
