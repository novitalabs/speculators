...
###############################################################################
# Exp 20-2: Continuous Datagen with Nemotron-v2 Chinese Subset
# Chinese-only subset extracted from nemotron-v2 (~125K samples).
# Hypothesis: Chinese-focused training improves ZClawBench (92% Chinese) speedup.
###############################################################################
...
TRAIN_DATA="${TRAIN_DATA:-/data/tengwan/datasets/nemotron-v2-chinese/}"
...
echo "============================================="
echo " Exp 20-2: Continuous Datagen (nemotron-v2 Chinese)"
