...
###############################################################################
# MiniMax-M2.1 Eagle3 Evaluation on ZClawBench Agent Prompts
# Compare: baseline, Aurora-Spec-M2.1, Exp14 ckpt54, Exp15 ckpt67
# Note: Aurora-Spec was trained FOR M2.1; Exp14/15 were trained for M2.5
###############################################################################
...
BASE_MODEL="${MODEL_PATH:-/data/models/MiniMax-M2.1}"
...
OUTPUT_DIR="/data/output/minimax_m2.1_eval_zclawbench"
TP="${TP:-4}"
...
###############################################################################
# Write the evaluation Python script (same as zclawbench eval but with M2.1)
###############################################################################
...
if __name__ == "__main__":
    ...
    print(f"\n{'='*80}")
    print(f"  FINAL SUMMARY — M2.1 ZClawBench Eval")
    print(f"{'='*80}")
