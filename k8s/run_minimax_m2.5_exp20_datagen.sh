...
###############################################################################
# Exp 20: Continuous Datagen with Nemotron-v2 Dataset
# Uses nemotron-v2 parquet dataset (6.3M samples). Runs in continuous loop mode:
...
TRAIN_DATA="${TRAIN_DATA:-/data/tengwan/datasets/nemotron-v2-jsonl/}"
...
echo "============================================="
echo " Exp 20: Continuous Datagen (nemotron-v2)"
