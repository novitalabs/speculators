...
###############################################################################
# Exp 20: Training with continuous datagen + difficulty feedback (nemotron-v2)
...
REMOTE_GEN_DIR="/data/output/minimax_m2.5_eagle3_exp20/gen"
VOCAB_DIR="$OUTPUT_PATH/vocab_mapping"

echo "============================================="
echo " Exp 20: Continuous Datagen Training (nemotron-v2)"
...
torchrun \
    ...
    --run-name "minimax_m2.5_eagle3_exp20" \
    2>&1 | tee "$TRAIN_LOG"
